...
const ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
  <defs>
    ...
    <linearGradient id="accent" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="#f2664b"/>
  ...
  <rect x="48" y="60" width="14" height="120" rx="6" fill="#f2664b" opacity="0.9"/>
  <rect x="32" y="160" width="14" height="20" rx="3" fill="#f2664b" opacity="0.5"/>
</svg>`
